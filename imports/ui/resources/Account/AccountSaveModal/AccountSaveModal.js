...
Template.AccountSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.AccountSaveModal.onRendered( function () {
    const modalElement = this.find('#AccountSaveModal');
...
Template.AccountSaveModal.helpers({
    showDocSaveModal() {
...
Template.AccountSaveModal.events({
