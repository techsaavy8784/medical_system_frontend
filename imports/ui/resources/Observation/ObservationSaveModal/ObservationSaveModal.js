import './ObservationSaveModal.html';
...
Template.ObservationSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.ObservationSaveModal.onRendered( function () {
    const modalElement = this.find('#ObservationSaveModal');
...
Template.ObservationSaveModal.helpers({
    showDocSaveModal() {
...
Template.ObservationSaveModal.events({
