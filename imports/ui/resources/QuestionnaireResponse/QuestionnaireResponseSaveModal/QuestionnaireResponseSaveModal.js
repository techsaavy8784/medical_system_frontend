import './QuestionnaireResponseSaveModal.html';
...
Template.QuestionnaireResponseSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.QuestionnaireResponseSaveModal.onRendered( function () {
    const modalElement = this.find('#QuestionnaireResponseSaveModal');
...
Template.QuestionnaireResponseSaveModal.helpers({
    showDocSaveModal() {
...
Template.QuestionnaireResponseSaveModal.events({
