import './DiagnosticReportSaveModal.html';
...
Template.DiagnosticReportSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.DiagnosticReportSaveModal.onRendered( function () {
    const modalElement = this.find('#DiagnosticReportSaveModal');
...
Template.DiagnosticReportSaveModal.helpers({
    showDocSaveModal() {
...
Template.DiagnosticReportSaveModal.events({
