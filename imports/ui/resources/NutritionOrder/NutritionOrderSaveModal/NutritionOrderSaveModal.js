import './NutritionOrderSaveModal.html';
...
Template.NutritionOrderSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.NutritionOrderSaveModal.onRendered( function () {
    const modalElement = this.find('#NutritionOrderSaveModal');
...
Template.NutritionOrderSaveModal.helpers({
    showDocSaveModal() {
...
Template.NutritionOrderSaveModal.events({
