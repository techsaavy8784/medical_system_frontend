...
Template.DeviceSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.DeviceSaveModal.onRendered( function () {
    const modalElement = this.find('#DeviceSaveModal');
...
Template.DeviceSaveModal.helpers({
    showDocSaveModal() {
...
Template.DeviceSaveModal.events({
