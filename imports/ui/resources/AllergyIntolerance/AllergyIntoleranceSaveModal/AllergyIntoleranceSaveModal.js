import './AllergyIntoleranceSaveModal.html';
...
Template.AllergyIntoleranceSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.AllergyIntoleranceSaveModal.onRendered( function () {
    const modalElement = this.find('#AllergyIntoleranceSaveModal');
...
Template.AllergyIntoleranceSaveModal.helpers({
    showDocSaveModal() {
...
Template.AllergyIntoleranceSaveModal.events({
