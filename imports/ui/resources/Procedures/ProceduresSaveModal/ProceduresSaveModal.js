import './ProceduresSaveModal.html';
...
Template.ProceduresSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.ProceduresSaveModal.onRendered( function () {
    const modalElement = this.find('#ProceduresSaveModal');
...
Template.ProceduresSaveModal.helpers({
    showDocSaveModal() {
...
Template.ProceduresSaveModal.events({
