import './MedicationRequestSaveModal.html';
...
Template.MedicationRequestSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.MedicationRequestSaveModal.onRendered( function () {
    const modalElement = this.find('#MedicationRequestSaveModal');
...
Template.MedicationRequestSaveModal.helpers({
    showDocSaveModal() {
...
Template.MedicationRequestSaveModal.events({
