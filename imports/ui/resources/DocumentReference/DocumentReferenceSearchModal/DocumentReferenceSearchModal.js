...
Template.DocumentReferenceSearchModal.helpers({
    ...
    documentReferenceFilter(type) {
        let documentReferenceFilters = Session.get('documentReferenceFilters');
        if(documentReferenceFilters){
            let identifier =  documentReferenceFilters.find(filter => filter.element === type)
