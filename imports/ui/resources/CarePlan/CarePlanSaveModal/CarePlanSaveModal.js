...
Template.CarePlanSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.CarePlanSaveModal.onRendered( function () {
    const modalElement = this.find('#CarePlanSaveModal');
...
Template.CarePlanSaveModal.helpers({
    showDocSaveModal() {
...
Template.CarePlanSaveModal.events({
