import "./CarePlanSearchModal.html";
...
Template.CarePlanSearchModal.onCreated(function CarePlanSearchModalOnCreated() {
...
Template.CarePlanSearchModal.onRendered(function CarePlanSearchModalOnRendered() {
    const modalElement = this.find('#CarePlanSearchModal');
    // $(modalElement).on('hidden.bs.modal', function (event) {
    //     $(this).find('form').trigger('reset');
    // })
});

Template.CarePlanSearchModal.helpers({
    filterCount(value) {
...
Template.CarePlanSearchModal.events({
    ...
    'click .reset': function (event, instance) {
        ...
        $('#CarePlanSearchModal').find('form')[0].reset();
    },
