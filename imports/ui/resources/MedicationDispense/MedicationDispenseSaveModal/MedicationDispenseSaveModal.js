import './MedicationDispenseSaveModal.html';
...
Template.MedicationDispenseSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.MedicationDispenseSaveModal.onRendered( function () {
    const modalElement = this.find('#MedicationDispenseSaveModal');
...
Template.MedicationDispenseSaveModal.helpers({
    showDocSaveModal() {
...
Template.MedicationDispenseSaveModal.events({
