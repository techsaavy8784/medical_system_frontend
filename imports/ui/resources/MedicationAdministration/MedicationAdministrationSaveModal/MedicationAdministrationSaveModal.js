import './MedicationAdministrationSaveModal.html';
...
Template.MedicationAdministrationSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.MedicationAdministrationSaveModal.onRendered( function () {
    const modalElement = this.find('#MedicationAdministrationSaveModal');
...
Template.MedicationAdministrationSaveModal.helpers({
    showDocSaveModal() {
...
Template.MedicationAdministrationSaveModal.events({
