...
Template.GoalSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.GoalSaveModal.onRendered( function () {
    const modalElement = this.find('#GoalSaveModal');
...
Template.GoalSaveModal.helpers({
    showDocSaveModal() {
