...
Template.CoverageSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.CoverageSaveModal.onRendered( function () {
    const modalElement = this.find('#CoverageSaveModal');
...
Template.CoverageSaveModal.helpers({
    showDocSaveModal() {
...
Template.CoverageSaveModal.events({
