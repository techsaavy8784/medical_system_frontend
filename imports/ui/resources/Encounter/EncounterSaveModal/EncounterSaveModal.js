import './EncounterSaveModal.html';
...
Template.EncounterSaveModal.onCreated(function resourceOnCreated(){
    Session.set("showDocSaveModal", false);
    Session.set("showDocFhirModal", false);
    Session.set("showXMLModal", false);
});

Template.EncounterSaveModal.onRendered( function () {
    const modalElement = this.find('#EncounterSaveModal');
...
Template.EncounterSaveModal.helpers({
    showDocSaveModal() {
...
Template.EncounterSaveModal.events({
